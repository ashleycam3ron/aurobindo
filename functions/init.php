...
function custom_login_logo(){
	$logo = get_stylesheet_directory_uri().'/images/Aurobindo-Logo.png';
	...
	echo '<style type="text/css">
			...
			.login #backtoblog a, .login #nav a, .login h1 a {color: #3c5b9a;font-weight: bold;}
			.wp-core-ui .button-primary,.wp-core-ui .button-primary:hover {
    background: #3c5b9a;
    border-color: #3c5b9a #006799 #006799;}
    .wp-core-ui .button-primary:hover{opacity:.95;}
		</style>';
}
