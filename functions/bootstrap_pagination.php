...
function wp_bs_pagination($pages = '', $range = 4){
     ...
     if(1 != $pages){
        ...
        echo '<nav><h4 class="hidden">Post Navigation</h4><ul class="pagination"><li class="disabled hidden-xs"><span><span aria-hidden="true">Page '.$paged.' of '.$pages.'</span></span></li>';
